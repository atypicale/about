...
class ReferencesControllerTest < ActionController::TestCase
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post :create, reference: { location: @reference.location, name: @reference.name, organization: @reference.organization, phone_number: @reference.phone_number, title: @reference.title }
    end
  ...
  test "should update reference" do
    put :update, id: @reference, reference: { location: @reference.location, name: @reference.name, organization: @reference.organization, phone_number: @reference.phone_number, title: @reference.title }
    assert_redirected_to reference_path(assigns(:reference))
  end
